document.addEventListener('DOMContentLoaded', function() {
	...
	dots.forEach((dot, index) => {
		dot.addEventListener('click', function() {
			...
			const slideTexts = [
				"O planeta precisa de você! Junte-se a nós e mostre que pequenas atitudes podem gerar grandes transformações.",
			...
			const slideTitles = ["PARTICIPE DO DESAFIO!", "PROTEJA", "COMUNIDADE", "EDUQUE-SE"];
